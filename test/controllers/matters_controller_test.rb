...
class MattersControllerTest < ActionController::TestCase
  ...
  test "should create matter" do
    assert_difference('Matter.count') do
      post :create, matter: { id_matter: @matter.id_matter, name: @matter.name, program_id: @matter.program_id }
    end
  ...
  test "should update matter" do
    patch :update, id: @matter, matter: { id_matter: @matter.id_matter, name: @matter.name, program_id: @matter.program_id }
    assert_redirected_to matter_path(assigns(:matter))
  end
